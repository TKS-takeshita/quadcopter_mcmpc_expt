...
namespace qc_mcmpc
{
    ...
    __device__ void input_array::do_simulation()
    {
        ...
        for ( int i = 0; i < _DEVICE_CONST_HORIZON; i++ )
        {
            ...
            thrust_setpoint[2] = (acc_setpoint[2]-a_of_gravity_device)*mpc_thr_hover/a_of_gravity_device/max_thrust_device;
            ...
            acc_produced[0] = a_of_gravity_device*thrust_setpoint[0]/mpc_thr_hover;
            acc_produced[1] = a_of_gravity_device*thrust_setpoint[1]/mpc_thr_hover;
            ...
            vel_int[0] += (vel_setpoint[0]-var_and_z_i_temp[10])*control_period_device;
            vel_int[1] += (vel_setpoint[1]-var_and_z_i_temp[11])*control_period_device;
            vel_int[2] += (vel_setpoint[2]-var_and_z_i_temp[12])*control_period_device;
