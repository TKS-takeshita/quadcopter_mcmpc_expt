...
const double CONST_PARAM::MOTOR_THRUST_CONSTANT_SDF = 1.0792e-5;
const double CONST_PARAM::MOTOR_THRUST_SCALE = 1.0;
const double CONST_PARAM::MOTOR_THRUST_CONSTANT =CONST_PARAM::MOTOR_THRUST_CONSTANT_SDF * CONST_PARAM::MOTOR_THRUST_SCALE;
const double CONST_PARAM::MOMENT_CONSTANT = 1.51e-7;
...
float mcmpc_log = 0.0f;
    ...
    const double CONST_PARAM::MAX_ROT_VELOCITY = 1121.83;
